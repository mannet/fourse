...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> > <?php echo ($goods["miaoshu"]); ?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
			<input type="hidden" name="uuo" value="<?php echo ($uuo); ?>"/>
				<h3><strong><?php echo ($goods["miaoshu"]); ?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="/Uploads/<?php echo ($goods["img_url"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/Uploads/<?php echo ($goods["img_url"]); ?>" width="350" height="350" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Uploads/<?php echo ($goods["img_url"]); ?>',largeimage: '/Uploads/<?php echo ($goods["img_url"]); ?>'}"><img src="/Uploads/<?php echo ($goods["img_url"]); ?>"></a>
								</li>
								<?php if(is_array($goosd_img)): $i = 0; $__LIST__ = $goosd_img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pp): $mod = ($i % 2 );++$i;?><li>
										<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Uploads/<?php echo ($pp["img_url"]); ?>',largeimage: '/Uploads/<?php echo ($pp["img_url"]); ?>'}"><img src="/Uploads/<?php echo ($pp["img_url"]); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo ($goods["addtime"]); echo ($goods["id"]); ?></li>
						<li class="market_price"><span>定价：</span><em>￥<?php echo ($goods["price"]); ?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo ($goods["price"]); ?></strong> <a href="">(降价通知)</a></li>
						...
						<ul>
							<li class="product">
								<dl>
									...
									<dd>
										...
										<a href="javascript:;">金色 <input type="radio" name="color" value="蓝色" /></a>
										<a href="javascript:;">14寸 <input type="radio" name="color" value="14寸" /></a>
										<a href="javascript:;">18寸 <input type="radio" name="color" value="18寸" /></a>
							...
							<li class="product">
								<dl>
									<dt>版本：</dt>
									<dd>
										<a href="javascript:;">i3 4G内存版 <input type="radio" name="ver" value="i3 4G内存版" /></a>
										<a href="javascript:;">i5 4G内存版 <input type="radio" name="ver" value="i5 4G内存版"  /></a>
										<a class="selected" href="javascript:;">i5 8G内存版<input type="radio" name="ver" value="i5 8G内存版" checked="checked" /></a>
										<a href="javascript:;">SSD超极本 <input type="radio" name="ver" value="SSD超极本" /></a>
										<input type="hidden" name="" value="" />
									</dd>
								</dl>
							</li>
							...
							<li>
								<dl>
									<dt>&nbsp;</dt>
									<dd>
										<input data-gid="<?php echo ($goods["id"]); ?>" class="cart add_btn" type="button" value=""/>
									</dd>
								</dl>
							</li>
	...
	<script type="text/javascript">
		$('.cart').click(function(){
			...
			$.post("<?php echo U('/Home/Index/addcart');?>",reqdata,function(jsonobj){
				alert(jsonobj.msg);
			},'json');
		});
