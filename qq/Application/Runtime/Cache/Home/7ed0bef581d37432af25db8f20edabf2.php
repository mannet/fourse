...
<body>
	...
	<div class="mycart w990 mt10 bc">
            <div class="panel-heading">
                <h2 style="font-size:20px;font-weight:bold;color:blue;"><span>基本信息</span></h2>
            </div>
            <div class="panel-body">
                <table class="mycart w990 mt10 bc">
                    <tbody>
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="font-size:20px;font-weight:bold;">
        ...
        <div class="mycart w990 mt10 bc">
            <div class="panel-heading">
                <h2 style="font-size:20px;font-weight:bold;color:blue;"><span>商品信息 </span></h2>
            </div>
            <div class="panel-body">
                <table class="mycart w990 mt10 bc">
                    <thead>
                    ...
                    <tbody>
                    <?php if(is_array($modeil)): $i = 0; $__LIST__ = $modeil;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><tr style="font-size:20px;font-weight:bold;">
							<td><?php echo ($good["order_sn"]); ?></td>
                            <td class="text-left"><?php echo ($good["name"]); ?></td>
                            <td class="text-right"><?php echo ($good["goods_num"]); ?></td>
                            <td class="text-right"><?php echo ($good["goods_price"]); ?></td>
                            <td class="text-right"><?php echo ($good["goods_ord"]); ?></td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>

                    <tr>
                        <td colspan="4" class="text-right" style="font-size:15px;font-weight:bold;color:blue">小计:</td>
                        <td class="text-right" style="font-size:20px;font-weight:bold;"><?php echo ($goodsprice); ?></td>
                    </tr>
                    </tbody>
                </table>
