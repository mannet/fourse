    ...
    <table class="table table-hover text-center">
      <tr>
		...
		<?php if(is_array($tref)): $i = 0; $__LIST__ = $tref;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ptt): $mod = ($i % 2 );++$i;?><tr align="center" valign="middle">
				...
				<td>
					<input data-gid="<?php echo ($ptt["id"]); ?>" class="button bg-main icon-check-square-o cart" type="button" value="立即购买"/> 
					<input data-gid="<?php echo ($ptt["id"]); ?>" class="button bg-main icon-check-square-o cart" type="button" value="加入购物车"/> 
				</td>
