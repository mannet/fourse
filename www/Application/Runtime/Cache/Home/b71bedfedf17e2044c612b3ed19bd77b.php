...
<body>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="goods">
				...
				<table>
					...
					<?php if(is_array($flow2)): $i = 0; $__LIST__ = $flow2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$aa): $mod = ($i % 2 );++$i;?><tr>
							<td data-id="<?php echo ($aa["id"]); ?>" id="ge"><?php echo ($aa["goodsname"]); ?></td>
							<td><?php echo ($aa["miaoshu"]); ?></td>
							<td><?php echo ($aa["attr_name"]); ?></td>
							<td style="border-left-width:100px;width:1px;"><img src="/Uploads/<?php echo ($aa["goods_img"]); ?>" width="50" height="50"/></td>
							<td><?php echo ($aa["price"]); ?></td>
							<td><?php echo ($aa["num"]); ?></td>
						...
						<tr>
							<td colspan="5">
								<ul>
									...
									<li>
										<span>运费：</span>
										<em>￥<?php echo ($yunfei); ?>元</em>
									</li>
									<li>
										<span>应付总额：</span>
										<em>￥<?php echo ($qian); ?>元</em>
									</li>
								</ul>
							</td>
						</tr>
		...
		<div class="fillin_ft">
			<a href="/Home/Index/flow3"><span>提交订单</span></a>
			<p>应付总额：<strong>￥<?php echo ($qian); ?>元</strong></p>
		</div>
	</div>
	<!-- 主体部分 end -->
...
var reqdata = {id:$('#ge').data('id')};
console.log(reqdata);
$.post("<?php echo U('/Home/Index/flow3');?>",reqdata,function(){
},'json');
</script>
</html>