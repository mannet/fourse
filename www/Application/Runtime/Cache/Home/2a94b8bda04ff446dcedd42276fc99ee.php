	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li>
								<dl>
									<dt><a href="<?php echo U('/Home/Index/goods/id/'.$row['id']);?>"><img src="/Uploads/<?php echo ($row["img_url"]); ?>"/></a></dt>
									<dd><a href="<?php echo U('/Home/Index/goods/id/'.$row['id']);?>"><?php echo ($row["miaoshu"]); ?></a></dd>
									<dd><span>售价：</span><strong>￥<?php echo ($row["price"]); ?></strong></dd>
								</dl>
