...
<body>
	...
	<div class="success w990 bc mt15">
		...
		<div class="success_bd">
			<p>订单号：<?php echo ($dingdan); ?></p>
			<p><span></span>订单提交成功，我们将及时为您处理</p>
			<p class="message">完成支付后，你可以 <a href="<?php echo U('/Home/Jiang/jiang/id/'.$order['id']);?>">转盘抽奖</a> <a href="">查看订单状态</a>  <a href="/Home/Index/index">继续购物</a> <a href="">问题反馈</a></p>
		</div>
	</div>
	<!-- 主体部分 end -->
